...
export default function EditVenue() {
    ...
    useEffect(() => {
        async function fetchVenue() {
            try {
                ...
                setImages(
                    (v.media || []).slice(0, 8).map((image: VenueImage) => ({
                        url: image.url,
                        alt: image.alt || v.name,
                    }))
                );
    ...
    if (fetching) {
        return (
            <main className="min-h-screen bg-[#FAFAF9] px-4 py-20 text-center">
            ...
            <div className="mx-auto max-w-3xl">
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-sm font-medium text-stone-500">
                        Update your accommodation details, images, price and amenities.
                    </p>
                </div>
                    ...
                    <div className="grid gap-5">
                        <div className="grid gap-1.5">
                            ...
                            <input
                                ...
                                className="rounded-xl border border-stone-200 bg-white px-4 py-3 text-sm text-stone-900 shadow-[inset_0_1px_3px_rgba(0,0,0,0.05)] outline-none transition-all duration-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10"
                                required
                            />
                            {errors.name && (
                        ...
                        <div className="grid gap-1.5">
                            ...
                            <textarea
                                ...
                                className="h-32 resize-none rounded-xl border border-stone-200 bg-white px-4 py-3 text-sm text-stone-900 shadow-[inset_0_1px_3px_rgba(0,0,0,0.05)] outline-none transition-all duration-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10"
                                required
                            />
                            {errors.description && (
                                <p className="text-xs font-medium text-red-600">
